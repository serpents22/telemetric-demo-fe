...
async function fetchReport() {
  ...
  if (chart) {
    ...
    options.series = []
    options.series.push({
      name: 'Total Suspended Solid',
      data: chartData.map(obj => [obj.date, obj.tmotor])
    })
...
const header = [
  ...
  { text: 'Total Suspended Solid', value: "tmotor", sortable: true, },
]
...
var options = {
  ...
  yaxis: {
    ...
    title: {
      text: 'Total Suspended Solid (mg/L)'  // Y-axis label with units
    },
    labels: {
      offsetX: 14,
      offsetY: -5
